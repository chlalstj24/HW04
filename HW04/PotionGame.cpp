...
void RecipeManager::showMenuList() {
...
void StockManager::craft(int idx) {
...
void StockManager::processReturn(const string& input) {
...
bool StockManager::checkWin() { return gold >= 1000; }
int StockManager::getTurn() { return turn; }
